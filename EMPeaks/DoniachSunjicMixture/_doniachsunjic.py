...
class DoniachSunjic:
    def __init__(self, x_min=-100, x_max=100, gamma_min=0.1, gamma_max=10):
        self.x_min = x_min
        self.x_max = x_max
    ...
    def init_model(self):
        ...
        self.alpha = np.random.uniform(0, 0.3)
        return
    ...
    def maximum_likelihood_estimation(self, x, intensity):
        ...
        # self.iterative_optimization(x, intensity, 1.0e-5, 100)
        return
    ...
    def full_optimization(self, x, intensity):
        ...
        info = optimize.minimize(func, x0=init, bounds=[(-200, 200), (0.1, 2000), (0, 0.3)], method='L-BFGS-B')
        self.x0 = info['x'][0]
        self.gamma = info['x'][1]
        self.alpha = info['x'][2]
        return
    ...
    def iterative_optimization(self, x, intensity, eps, max_iter):
        ...
        alpha_grid = np.arange(0, 0.3, 0.001)
